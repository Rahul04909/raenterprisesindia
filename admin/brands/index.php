    ...
    <div class="admin-content">
        ...
        <main class="admin-main">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <a href="add.php" class="add-new-btn">Add New Brand</a>
            </div>
                        ...
                        <?php foreach ($brands as $brand): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="delete.php?id=<?php echo $brand['id']; ?>" class="action-btn delete-btn" onclick="return confirm('Are you sure you want to delete this brand?');">Delete</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
